...
export class RppgPipeline {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(RppgPipeline.prototype);
        obj.__wbg_ptr = ptr;
        RppgPipelineFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        RppgPipelineFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_rppgpipeline_free(ptr, 0);
    }
}
if (Symbol.dispose) RppgPipeline.prototype[Symbol.dispose] = RppgPipeline.prototype.free;
...
export class WasmRppgPipeline {
    ...
    constructor(sample_rate, window_sec) {
        ...
        return RppgPipeline.__wrap(ret);
    }
    /**
...
const RppgPipelineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_rppgpipeline_free(ptr >>> 0, 1));
