...
export class RppgGatingController {
    ...
    update(input) {
        ...
        const stableFresh = this.lastStableBpm != null &&
            this.lastStableAtMs != null &&
