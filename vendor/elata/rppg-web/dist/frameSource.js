...
export function averageGreenInROI(frame, x, y, w, h) {
...
export function averageRgbInROI(frame, x, y, w, h) {
    const data = frame.data;
    const width = frame.width;
    let sumR = 0;
    let sumG = 0;
...
export function averageGreenInROIWithSkinMask(frame, x, y, w, h) {
    return averageGreenInROIWithSkinMaskStats(frame, x, y, w, h).intensity;
}
export function averageGreenInROIWithSkinMaskStats(frame, x, y, w, h) {
    const data = frame.data;
    const width = frame.width;
    let sum = 0;
    let count = 0;
...
export function averageRgbInROIWithSkinMaskStats(frame, x, y, w, h) {
    const data = frame.data;
    const width = frame.width;
    let sumR = 0;
    let sumG = 0;
    ...
    if (skinCount === 0)
        return { r: 0, g: 0, b: 0, skinRatio, clipRatio };
    return {
